<template>
  <div class="relative w-full max-w-5xl mx-auto flex flex-col gap-8 pb-12">
    ...
    <div
      class="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-3xl h-64 bg-teal-500/10 blur-[100px] rounded-full pointer-events-none -z-10"
    />
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-5">
        <NuxtLink
          to="/admin/students"
          class="group flex items-center justify-center w-12 h-12 rounded-2xl bg-slate-800/80 border border-slate-700/50 text-slate-400 hover:text-white hover:bg-slate-800 hover:border-teal-500/50 hover:shadow-[0_0_15px_rgba(20,184,166,0.15)] transition-all duration-300"
        >
          <svg
        ...
        <div>
          <h1
            class="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400 tracking-tight"
          >
    ...
    <transition name="fade">
      <div
        v-if="errorMsg"
        class="flex items-start gap-3 p-4 rounded-2xl bg-red-500/10 border border-red-500/20 shadow-lg shadow-red-500/5 backdrop-blur-md text-red-400"
      >
    ...
    <form class="relative group" @submit.prevent="handleSubmit">
      ...
      <div
        class="gradient-border absolute -inset-[1px] bg-gradient-to-b from-slate-700/80 to-slate-800/20 rounded-[2rem] z-0 opacity-50 group-hover:from-teal-500/30 group-hover:to-slate-800/20 transition-all duration-500"
      />

      <div
        class="relative glass-panel create-panel p-8 sm:p-10 rounded-[2rem] z-10 shadow-2xl flex flex-col gap-10"
      >
        <!-- Section: Basic Details -->
        <div class="flex flex-col gap-6">
          <div
            class="flex items-center gap-3 pb-4 border-b border-slate-800/60"
          >
            <div
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="input-group">
              <label
                ...
                <span class="text-teal-400">*</span></label
              >
              <div class="relative">
            ...
            <div class="input-group">
              ...
              <div class="relative">
                ...
                <select
                  v-model="form.status"
                  class="input-element appearance-none pr-10"
                >
            ...
            <div class="input-group">
              ...
              <div class="relative">
                ...
                <select
                  ...
                  required
                  class="input-element appearance-none pr-10"
                  :class="{ 'text-slate-500': form.gender === '' }"
                >
                  <option value="" disabled>
                    {{ locale === "lo" ? "ເລືອກເພດ..." : "Select gender..." }}
                  </option>
        ...
        <!-- Form Actions -->
        <div
          class="mt-4 pt-8 border-t border-slate-800/60 flex items-center justify-end gap-5"
        >
          <NuxtLink
            to="/admin/students"
            class="px-6 py-3 rounded-xl text-sm font-semibold text-slate-300 hover:text-white hover:bg-slate-800/80 transition-colors cancel-btn"
          >
            {{ $t("common.cancel") }}
          </NuxtLink>
          <button
