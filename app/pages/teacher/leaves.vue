<template>
  <div class="flex flex-col gap-6">
    ...
    <div v-if="teacherStore.loadingLeaveRequests" class="py-12 flex justify-center">
...
:class="[
        ...
        <div class="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl">
          ...
          <p class="text-sm text-slate-700 dark:text-slate-300 mt-2"><span class="font-semibold text-slate-900 dark:text-slate-400">{{ $t('teacherPortal.reason') }}</span> {{ locale === 'lo' ? req.reasonLo : req.reasonEn }}</p>
